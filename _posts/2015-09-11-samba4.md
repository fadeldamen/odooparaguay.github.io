...
> Nota: Você deve estar se perguntando o que significa este -m 1777 certo? -m é um parâmetro de "mode" para atribuir permissões tipo "chmod". Já a permissão 1777, este "1" a frente significa bitstickc. Em termos práticos, quer dizer exatamente isto **não deixe ninguém excluir esta pasta ou mudar a permissão"**.
