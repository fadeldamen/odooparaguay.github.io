...
* **[Preparando integracao dominio samba com AD](#preparando-integracao-dominio-samba-com-ad)**
* **[Adicionando dominio samba em um controlador AD existente](#adicionando-)**
...
### Samba4 como um dominio membro AD (Replica)

---


### Preparando integracao dominio samba com AD


---

### Adicionando dominio samba em um controlador AD existente


---

### Verificacao de entradas DNS para novo host
