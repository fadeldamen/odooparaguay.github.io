...
* **[Migrando um dominio samba 3 PDC para Samba 4 AD](#)**
* **[Samba Tools](#)**
* **[Upgrading](#)**
* **[Migrando Grupos](#)**
...
{% highlight bash %}
# samba-tool domain classicupgrade --dbdir=root/backup/var/lib/samba/ --use-xattrs=yes --dns-backend=SAMBA_INTERNAL_DLZ --realm=empresa /root/backup/etc/samba/smb.conf
{% endhighlight %}
