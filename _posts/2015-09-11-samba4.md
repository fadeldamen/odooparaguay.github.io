...
* **[Instalacao do Debian stable](#instalacao-do-debian)**
...
Para adiquirir o Cent0S, acesso o url a seguir: 
**[Download Cent0s](https://www.centos.org/download/)** - costumo baixar a ISO (mas não é obrigatório).
Para adiquirir o Debian Stable, acesse o url a seguir:
...
**Debian**
{% highlight bash %} 
# Adicione esta linha no /etc/apt/sources.list caso não exista com seu editor de texto 
...
# Com o comando a cima, o **[virtualbox-dkms](https://packages.debian.org/jessie/virtualbox-dkms)** também será instalado
{% endhighlight %}
