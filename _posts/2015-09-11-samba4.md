...
Assim como recomendei a cima estudar sobre particionamento de disco, volto a pedir para que estude sobre isto. Afinal, é de suma importância que você saiba particionar adequadamente o disco. Nos exemplos citados aqui, irei particionar de forma simples afim de resumir bastante coisa no processo básico de instalação do sistema operacional. Portanto, **não use este exemplo para todas as aplicações futuras** que você fizer.
...
Afim de não tornar este processo **redundante**, há diversos tutoriais ensinando a instalar o CentOS passo-a-passo e com screenshot como fiz a cima no caso do Debian. Geralmente, lidar com o CentOs acaba sendo mais resumido e simples do que o Debian em muitas coisas. A instalação não é uma dessas coisas.
...
> Nota: Preste bastante atenção quando chegar em **Software Selection**. Pois, é aí que você irá definir para que propósito está instalando o seu CentOs. Isto é, para servidor? para desktop? para infra-estrutura?geralmente eu coloco o **"minimal install"** pois vem apenas com o básico do CentOs e sem interface gráfica. 

> Se você tiver dificuldade em instalar o CentOs, me mande um e-mail para que eu possa registrar aqui o passo-a-passo se necessário.
