...
Você poderá usar o nano,vi ou vim. No entanto, o vim precisa ser instalado pois não vem por padrão:
...
Seja qual for o erro, faz bem investigar o log.
...
{% highlight bash %}
samba-tool domain provision --use-rfc2307 --realm=QUALQUERNOME.COM.BR \
--domain=QUALQUERNOME --server-role=dc --dns-backend=SAMBA_INTERNAL \
