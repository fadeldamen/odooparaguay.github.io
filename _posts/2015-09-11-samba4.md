...
Pós a configuração do hostname, você terá que definir seu domínio por exemplo, **seudominio.com.br** o sistema pedirá que o usuário crie uma senha de usuário 'root'. Certifique-se de não esquecer esta senha, pois não é um processo divertido tentar recuperar a senha de root caso seja descuidado:
...
> Nota: O Network Time Protocol (NTP) é um protocolo de rede para sincronização do relógio entre sistemas e computadores e medir a latência da rede basicamente.
...
<div style="color:#ccff33; background:#2a2a2a">
