...
Isto é, sync sincroniza os dados sistema caso ocorra acidentalmente uma sobrecarga e o servidor seja reiniciado. Por fim, basta reiniciar o serviço NFS para validar as novas configurações:
